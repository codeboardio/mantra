...
describe('Test Mantra with Haskell-HSpec compilation', function () {

  this.timeout(testConfig.timeOut);

  it('Mantra Haskell-HSpec: successful compilation (one file)', function (done) {
    var folder = testConfig.getTestResource("haskell/hs_one_file");

    utilTest.generateTestFromFolder(folder, "Haskell-HSpec", "compile", function (data) {
      request(app)
        .post('/')
        .send(data)
  ...
  it('Mantra Haskell-HSpec: successful compilation (several files)', function (done) {
  ...
  it('Mantra Haskell-HSpec: successful compilation (several files in folders)', function (done) {
  ...
  it('Mantra Haskell-HSpec: error in setting file', function (done) {
  ...
  it('Mantra Haskell-HSpec: error in setting file (missing setting file)', function (done) {
  ...
  it('Mantra Haskell-HSpec: error in compilation (one file)', function (done) {
  ...
  it('Mantra Haskell-HSpec: error in compilation (missing main file)', function (done) {
  ...
  it('Mantra Haskell-HSpec: error in compilation (several files)', function (done) {
  ...
  it('Mantra Haskell-HSpec: successful incremental compilation ', function (done) {
  ...
  it('Mantra Haskell-HSpec: error in incremental compilation ', function (done) {
  ...
  it('Mantra Haskell-HSpec: successful incremental compilation with wrong ID', function (done) {
  ...
  it('Mantra Haskell-HSpec: successful run (one file)', function (done) {
  ...
  it('Mantra Haskell-HSpec: successful run (several files)', function (done) {
  ...
  it('Mantra Haskell-HSpec: successful run (several files in folders)', function (done) {
  ...
  it('Mantra Haskell-HSpec: invalid run due to invalid ID', function (done) {
    var folder = testConfig.getTestResource("haskell/hs_run_invalid_id");

    utilTest.generateTestFromFolder(folder, "Haskell-HSpec", "run", function (data) {
      data.id = "INVALID_ID";
      request(app)
        .post('/' + data.id)
        .send(data)
