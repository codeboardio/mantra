...
describe('Test Mantra with Java compilation', function () {
  ...
  it('Mantra Java: successful compilation (one file)', function (done) {
    ...
    utilTest.generateTestFromFolder(folder, "Java", "compile", function (data) {
      request(app)
        .post('/')
        .send(data)
  ...
  it('Mantra Java: error in compilation (another error)', function (done) {
  ...
  it('Mantra Java: successful compilation (several files with tests)', function (done) {
  ...
  it('Mantra Java: error compilation (several files with tests)', function (done) {
  ...
  it('Mantra Java: successful incremental compilation (3 calls with build argument) ', function (done) {
  ...
  it('Mantra Java: error in incremental compilation ', function (done) {
  ...
  it('Mantra Java: invalid run due to invalid ID', function (done) {
    ...
    utilTest.generateTestFromFolder(folder, "Java", "run", function (data) {
      data.id = "INVALID_ID";
      request(app)
        .post('/' + data.id)
        .send(data)
  ...
  it('Mantra Java: From Folder: testProject1 - FindPairs (successful compilation and run)', function (done) {
  ...
  it('Mantra Java: From Folder: testProject2 - JavaPuzzle (successful compilation and run)', function (done) {
  ...
  it('Mantra Java: From Folder: testProject2 - Find Template (successful compilation and run)', function (done) {
  ...
  it('Mantra Java: successful run (one file, bin defined in config file)', function (done) {
...
describe('Test Java: Running generates correct output', function () {

  this.timeout(testConfig.timeOut);

  it('Mantra Java: From Folder: testProject5 - Output has 2 newlines if last statement has newline', function (done) {
